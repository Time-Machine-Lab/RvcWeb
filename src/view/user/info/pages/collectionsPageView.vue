...
import { PostVo, UserCollectPostForm } from '@/api/post/postType';
import { getUserCollectPosts } from '@/api/post/postApi';
import { UserCollectModelForm, RvcModelVo } from '@/api/rvcModel/modelType';
...
const loadPost = function () {
    ...
    disabled.value = true
    loading.value = true
    postForm = ref<UserCollectPostForm>({
        data: '',
        limit: '10',
        page: page.value as unknown as string
    })
...
const loadModel = function () {
    ...
    disabled.value = true
    loading.value = true
    modelForm = ref<UserCollectModelForm>({
        limit: '10',
        page: page.value as unknown as string,
        order: '3'
    })
