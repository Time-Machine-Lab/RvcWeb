...
.welcome {
  ...
  .overlay{
    ...
    right: 0;
    bottom: 0;
    width: 500px; /* 调整为图片右侧的宽度 */
    background: linear-gradient(to right, rgba(255, 255, 255, 0),rgb(250, 242, 240)); /* 渐变背景 */
  }
  .welcome-card {
    position: absolute;
    ...
    .welcome-card__title:hover{
      transform: scale(1.1);
      color: #181818;
    }
    .welcome-card__title img{
      height:100%;
    }
    .welcome-card__contain {
      width: 100%;
      height: 30%;
      color: #868585;
    }
