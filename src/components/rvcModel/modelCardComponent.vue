    ...
    <div class="model-card">
      ...
      <div class="model-card__info">
        ...
        <div class="model-card__info__userInfo">
          <div
            class="model-card__info__userInfo__avatar"
            :style="{ backgroundImage: 'url(' + props.model.avatar + ')' }"
          ></div>
        ...
        <div class="model-card__info__stats">
          ...
          <div
            class="model-card__info__stats__item"
            v-if="!props.model.has_like"
          >
...
.model-card__pic {
  width: 100%;
  height: 100%;
  background-image: url("/public/backPic/introduction.png");
...
.model-card:hover > .model-card__pic {
  scale: 1.1;
}
...
.model-card__info__stats__item {
  height: 16px;
  display: flex;
  margin-right: 10px;
}

.model-card__info__stats__item span {
